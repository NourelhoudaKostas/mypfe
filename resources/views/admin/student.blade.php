                                            ...
                                            <div class="modal-body">
                                                <form id="editstudentForm" action="{{route('updatestudent',['id'=>$student->id])}}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="modalInput" type="file" name="profile_picture" id="editprofile_picture" value="{{$student->profile_picture}}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" id="edit_email" name="email" value="{{ $student->email_student }}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="edit_module" name="module" value="{{$student->module}}"  >
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="edit_course_code" name="Course_Code" value="{{$student->Course_Code}}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="edit_telephone" class="form-label">Telephone Number</label>
                                                        <input type="text" class="form-control" id="edit_telephone" name="telephone" value="{{$student->telephone}}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="edit_age" name="age" value="{{ $student->age }}">
                                                    </div>
                                                     <div class="mb-3">
                                                        <label for="edit_gender" class="form-label">gender</label>
                                                        <input type="text" class="form-control" id="edit_gender" name="gender" value="{{ $student->gender }}">
                                                    </div>
